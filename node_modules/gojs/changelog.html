...
<body onload="goDoc()">
  ...
  <div class="container-fluid mt70 plr15">
    ...
    <ul>
      ...
      <li>
        Fixed a problem with <a>Brush.isDark</a> sometimes using an incorrect ordering of <a>Brush.colorStops</a>
    ...
    <ul>
      ...
      <li>
        Fixed an issue where setting a node key reference in either a node or link via <a>GraphLinksModel.setGroupKeyForNodeData</a>,
        <a>GraphLinksModel.setFromKeyForLinkData</a>, or <a>GraphLinksModel.setToKeyForLinkData</a> could fail to resolve
    ...
    <ul>
      ...
      <li>
        Fixed a bug in <a>Panel.graduatedValueForPoint</a> in cases where the main shape was a diagonal line
  ...
  return !this.diagram.selection.any(function(p) { return p.data.key.indexOf("e") >= 0; })
    ...
    <h4>Changes for 2.0 and previous are <a href="../2.0.21/changelog.html">here</a>.</h4>
